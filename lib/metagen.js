...
function grm(filepath, toAppend, toAppendR, elmSharedFolder, outputFile, cb) {
    ...
    if (typeof filepath === 'object') {
        ...
        str = require('./allFiles')(fullPath, appendThisToDependencies, appendThisToReturnedItems, eliminateSharedFolder);
    }
    else {
        ...
        str = require('./allFiles')(fullPath, toAppend, toAppendR, elmSharedFolder);
    }
